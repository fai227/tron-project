...
### プログラム実行方法
本プログラムの実行には，micro:bitを4台とMaqueenを3台を用意する必要がある．ただし，最低限micro:bit2台とmaqueen1台で動作するが，今回の実験ではmicro:bitを4つmaqueenを3つ使うことを想定している．<br>
...
車両を道路環境上の決められた地点にセットし，走行を開始する．<br>
