...
このグリッドは，5×5の構造を持ち，各セルにはIDが割り振られている．セルのIDは，左上から右下に向けて座標平面のように定義されており，例えば左上が(0,0)，右下が(4,4)となる．ただし，特定のエリア（(1,1)，(1,3)，(3,1)，(3,3)）は通行不可能なゾーンとして設定する．<br>以下に道路環境の図を示す．<br>
